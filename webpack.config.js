...
module.exports = {
    ...
    entry: {
        //主入口
        index: ['webpack/hot/dev-server', './src/comm/script/index.js'],
        //es6入口
        'es6-index': ['webpack/hot/dev-server', './src/comm/script/es6-index.js']
    },
    output: {
        path: './dist',
        //线上环境采用下面的配置
        //publicPath: "http://blog.fastui.cn/assset/",
        //filename: 'comm/js/bundle.js'
        filename: "comm/js/[name].bundle.js"
    },
    //启动调试服务器用的
    devServer: {
        inline: true,
    ...
    plugins: [
        ...
        new htmlWebpackPlugin({
            ...
            //从哪个模板生成
            template: 'src/comm/html/es6-index.html',
            //脚本放的位置
            inject: 'head',//'head',
            //引入哪个打包后的js入口文件
            chunks: ['es6-index']
        ...
        new CopyWebpackPlugin([
            ...
            {from: './src/comm/font', to: 'comm/font/'},
